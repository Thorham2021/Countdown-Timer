...
class Application(tk.Frame):
    ...
    def build_interface(self):
        ...
        self.instruction.configure(bg='#ffffff', fg='#1c1c1c')

        self.time_entry = tk.Entry(self)
        self.time_entry.grid(row=1, column=1)
        self.time_entry.configure(bg='#ffffff', fg='#1c1c1c')

        self.clock = tk.Label(self, text="00:00:00", font=("Space Mono", 20), width=10)
        self.clock.grid(row=2, column=1, sticky="WE")
        self.clock.configure(bg='#ffffff', fg='#1c1c1c')
        ...
        self.time_label.configure(bg='#ffffff', fg='#1c1c1c')
        ...
        self.power_button.configure(bg='#ffffff', fg='#1c1c1c')
        ...
        self.reset_button.configure(bg='#ffffff', fg='#1c1c1c')
